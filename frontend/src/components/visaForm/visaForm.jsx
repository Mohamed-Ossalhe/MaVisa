...
const VisaForm = () => {
    ...
    const changeHandler = (e) => {
        setData({...data,[e.target.name]: e.target.value, rdv_date: JSON.parse(sessionStorage.getItem("rdv-date")), rdv_time: JSON.parse(sessionStorage.getItem("rdv-time"))});
    }
    ...
    return (
        <div className="form-wrapper flex items-start gap-2 px-12">
            <div className="image w-1/3"></div>
                            ...
                            <div className="field-wrapper flex items-center gap-4">
                                ...
                                <div className="field w-1/2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type="email" name="address" id="address" onChange={changeHandler} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="Address" />
                                    </div>
                                </div>
                            </div>
                        </div>
